            ...
            <div className="h-[32rem] bg-gray-100 dark:bg-gray-800">
                <div className="container px-6 py-10 mx-auto">
                    ...
                    <p className="max-w-2xl mx-auto mt-6 text-center text-gray-500 dark:text-gray-300">
                        Nossa equipe de colaboradores, responsáveis pela elaboração e implementação do BOManejoWeb
                    </p>
                </div>
            </div>
            ...
            <div className="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
                    <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700 shadow-md">
                        ...
                        <p className="mt-2 text-gray-500 capitalize dark:text-gray-300">Engenheiro Florestal</p>
                    ...
                    <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700 shadow-md">
                        ...
                        <p className="mt-2 text-gray-500 capitalize dark:text-gray-300">Programador Fullstack</p>
                    ...
                    <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700 shadow-md">
                        ...
                        <p className="mt-2 text-gray-500 capitalize dark:text-gray-300">Consultor e Analista</p>
